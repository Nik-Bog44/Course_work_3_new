...
def main_page():
    ...
    return render_template("index.html", posts=posts_data,
                           bookmarks_quantity=bookmarks_quantity)
...
def post_page(postid):
    ...
    return render_template("post.html", post=output_post, comments=output_comments,
                           quantity=comments_quantity, tags=tags)
...
def search_page():
    ...
    if s is None:
        return "Введите параметер для поиска"
    s = s.lower()
...
def tag_page(tagname):
    post_data = functions.open_json("data/data.json")
    ...
    for post in post_data:
        ...
        return render_template("tag.html",
                               output_posts=output_posts, tagname=tagname)
